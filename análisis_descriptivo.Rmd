...
muertes_cr$edadsrec <-
  gsub("100 y mÃ¡s", "100 - 121", muertes_cr$edadsrec)
muertes_cr$autopsia <- gsub("Ã©", "e", muertes_cr$autopsia)
muertes_cr$asistmed <- gsub("Ã©", "e", muertes_cr$asistmed)
muertes_cr$reginec <-
  gsub("Paci­fico", "Pacifico", muertes_cr$reginec)
muertes_cr$regsalud <-
  gsub("Paci­fico", "Pacifico", muertes_cr$regsalud)
...
Enfermedades infecciosas y parasitarias (1): Ciertas enfermedades infecciosas y parasitarias $1$.

Enfermedades crónicas y degenerativas (2): Tumores (neoplastias) $2$, enfermedades en el sistema circulatorio $7$, enfermedades del sistema respiratorio $8$, enfermedades del sistema digestivo $9$, enfermedades del sistema genitourinario $10$ y enfermedades del sistema osteomuscular y del tejido conjuntivo $13$.

Trastornos metabólicos y nutricionales (3): Enfermedades endocrinas, nutricionales y metabólicas $3$, enfermedades de la sangre y de los órganos hematopoyéticos, ciertos trastornos que afectan al mecanismo de la inmunidad $4$.

Trastornos mentales y del comportamiento (4): Trastornos mentales y del comportamiento $5$, enfermedades del sistema nervioso y de los órganos de los sentidos del ojo y sus anexos, del oído y de la apófisis mastoides $6$.

Condiciones especiales y anomalías (5): Complicaciones del embarazo, del parto y del puerperio $11$, enfermedades de la piel y del tejido celular subcutaneo $12$, malformaciones congénitas, deformidades y anomalías cromosómicas $14$, ciertas afecciones originadas en el periodo perinatal $15$, signos, síntomas y hallazgos anormales clínicos y de laboratorio no clasificados en otra parte $16$ y Causas externas de morbilidad y mortalidad $17$.
...
muertes_cr <- muertes_cr %>%
  mutate(grp_muerte = case_when(
    grgruposcb %in% c(1) ~ 1,
    grgruposcb %in% c(2, 7, 8, 9, 10, 13) ~ 2,
    grgruposcb %in% c(3, 4) ~ 3,
    grgruposcb %in% c(5, 6) ~ 4,
    grgruposcb %in% c(11, 12, 14, 15, 16, 17) ~ 5
  ))
