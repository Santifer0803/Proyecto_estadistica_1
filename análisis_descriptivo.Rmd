...
tabla_1 <- table(muertes_cr$grp_muerte, muertes_cr$regsalud)

tabla_2 <- table(muertes_cr$grp_muerte, muertes_cr$nacionalid)

tabla_3 <- table(muertes_cr$grp_muerte, muertes_cr$sexo)

tabla_4 <- table(muertes_cr$grp_muerte, muertes_cr$estcivil)

tabla_5 <- table(muertes_cr$grp_muerte, muertes_cr$ocuparec)

tabla_6 <- table(muertes_cr$grp_muerte, muertes_cr$edadsrec)

tabla_7 <- table(muertes_cr$grp_muerte, muertes_cr$pc)

tabla_8 <- table(muertes_cr$grp_muerte, muertes_cr$pcregis)
...
lista_stad[[1]] <- chisq.test(x = tabla_1, correct = TRUE)

lista_stad[[2]] <- chisq.test(x = tabla_2, correct = TRUE)

lista_stad[[3]] <- chisq.test(x = tabla_3, correct = TRUE)

lista_stad[[4]] <- chisq.test(x = tabla_4, correct = TRUE)

lista_stad[[5]] <- chisq.test(x = tabla_5, correct = TRUE)

lista_stad[[6]] <- chisq.test(x = tabla_6, correct = TRUE)

lista_stad[[7]] <- chisq.test(x = tabla_7, correct = TRUE)

lista_stad[[8]] <- chisq.test(x = tabla_8, correct = TRUE)
