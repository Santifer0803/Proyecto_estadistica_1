...
Luego, se procede con la división de 4 grupos de enfermedades realizada por los integrantes del grupo.

```{r Pruebas_independencia_grp}

# Se continúa con los valores del grupo de muerte elaborado por el grupo de trabajo
chisq.test(x = tabla_1_mod, correct = TRUE)

chisq.test(x = tabla_2_mod, correct = TRUE)

chisq.test(x = tabla_3_mod, correct = TRUE)

chisq.test(x = tabla_4_mod, correct = TRUE)

chisq.test(x = tabla_5_mod, correct = TRUE)
