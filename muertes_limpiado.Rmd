...
Muertes_CR$nacionalid <- gsub("^(?!Costa Rica$).*", "Extrenjero", Muertes_CR$nacionalid, perl = TRUE)
```
...
Se resumiran algunas de las variables de la base de datos con visualizaciones.
