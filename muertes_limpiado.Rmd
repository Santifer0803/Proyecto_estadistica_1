...
```{r Descarga_base}
library(readxl)
Muertes_CR <- read_excel("C:/Users/em415/Downloads/Proyecto Estadística/Base de datos/Costa Rica Total de Fallecimientos 2014 - 2021 (xlsx).xlsx")
```
...
Muertes_CR$ocuparec <- gsub("Profesionales cientificos e intelectuales", "Trabajadores activos", Muertes_CR$ocuparec)
...
```{r message = FALSE, warning = FALSE, Gráfico}
library(ggplot2)
...
## Gráficos de covarianza

### Relaciones entre los grupos de la causa de muerte y las demás variables importantes

Primero se realizan gráficos de frecuencia poligonal para visualizar la covarianza entre la variable principal, grupos de muerte, y las demás variables importantes

```{r message = FALSE, warning = FALSE, Visualizaciones_covarianza_frecuencia}
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = nacionalid), binwidth = 500, linewidth = 1.2) +
  labs(x = "Grupos de causa de muerte", y = "Nacionalidad", color = "Nacionalidades") +
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = sexo), binwidth = 500, linewidth = 1.2) +
  labs(x = "Grupos de causa de muerte", y = "Sexo", color = "Sexos") +
  scale_color_manual(values = colores_aleatorios) +
  theme_minimal()
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = estcivil), binwidth = 500, linewidth = 1.2) +
  labs(x = "Grupos de causa de muerte", y = "Estado civil", color = "Estados civiles") +
  scale_color_manual(values = colores_aleatorios) +
  theme_minimal()
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = ocuparec), binwidth = 500, linewidth = 1.2) +
  labs(x = "Grupos de causa de muerte", y = "Ocupación", color = "Ocupaciones") +
  scale_color_manual(values = colores_aleatorios) +
  theme_minimal()
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = regsalud), binwidth = 500, linewidth = 1.2) +
  labs(x = "Grupos de causa de muerte", y = "Región del Ministerio de Salud", color = "Regiones del Ministerio de Salud") +
  scale_color_manual(values = colores_aleatorios) +
  theme_minimal()

```

Ahora se realizan gráficos de frecuencia poligonal por medio de la densidad para visualizar mejor las covarianzas y relaciones antes descritas 

```{r message = FALSE, warning = FALSE, Visualizaciones_covarianza_densidad}
...
ggplot(Muertes_CR, aes(x = grgruposcb, y = after_stat(density))) + 
  geom_density(aes(color = nacionalid), linewidth = 1.2) +
  labs(title = "Covarianza entre los grupos de causa de muerte y las nacionalidades", x = "Grupos de causa de muerte", y = "Densidad", color = "Nacionalidades") +
  scale_color_manual(values = colores_aleatorios) +
  theme_minimal()
...
Ahora se realizan gráficos de caja y bigotes para una mejor visualización de la covarianza entre los grupos de muerte y las demás variables importantes

```{r message = FALSE, warning = FALSE, Visualizaciones_covarianza_boxplot}

library(ggplot2)

library(forcats)

ggplot(Muertes_CR, aes(x = fct_reorder(nacionalid, grgruposcb, median), y = grgruposcb)) +
  geom_boxplot() +
  labs(x = "Nacionalidades", y = "Grupos de causa de muerte") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = fct_reorder(sexo, grgruposcb, median), y = grgruposcb)) +
  geom_boxplot() +
  labs(x = "Sexos", y = "Grupos de causa de muerte") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = fct_reorder(estcivil, grgruposcb, median), y = grgruposcb)) +
  geom_boxplot() +
  labs(x = "Estados civiles", y = "Grupos de causa de muerte") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = fct_reorder(ocuparec, grgruposcb, median), y = grgruposcb)) +
  geom_boxplot() +
  labs(x = "Ocupaciones", y = "Grupos de causa de muerte") +
  theme_minimal()

ggplot(Muertes_CR, aes(x =  grgruposcb, y = fct_reorder(regsalud, grgruposcb, median))) +
  geom_boxplot() +
...
Ahora se realizarán gráficos de covarianza entre algunas de las variables importantes, excluyendo el grupo de causa de muerte, para visualizar si hay alguna relación entre ellas

```{r message = FALSE, warning = FALSE, Visualizaciones_adicionales}

library(ggplot2)

ggplot(Muertes_CR, aes(x = nacionalid, y = regsalud)) +
  geom_count() +
  labs(x ="Nacionalidades", y = "Regiones del Ministerio de Salud") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = sexo, y = estcivil)) +
  geom_count() +
  labs(x ="Sexos", y = "Estados civiles") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = sexo, y = ocuparec)) +
  geom_count() + 
  labs(x ="Sexos", y = "Ocupaciones") +
  theme_minimal()

ggplot(Muertes_CR, aes(x = estcivil, y = ocuparec)) +
  geom_count() +
