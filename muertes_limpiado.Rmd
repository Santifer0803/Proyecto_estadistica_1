...
a = ' categorias <- length(unique(Muertes_CR$nacionalid))

colores_aleatorios <- rainbow(categorias)

ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = nacionalid), binwidth = 1, linewidth = 1.2) +
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = sexo), binwidth = 1, linewidth = 1.2) +
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = estcivil), binwidth = 1, linewidth = 1.2) +
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = ocuparec), binwidth = 1, linewidth = 1.2) +
...
ggplot(Muertes_CR, aes(x = grgruposcb)) + 
  geom_freqpoly(aes(color = regsalud), binwidth = 1, linewidth = 1.2) +
...
Primero se realizan histogramas relacionando los grupos de causa de muerte (eje x) y la cantidad de observaciones (eje y) de las diferentes subcategorías de las variables importantes
...
ggplot(Muertes_CR, aes(x = grgruposcb, y = after_stat(density), fill = nacionalid)) +
  geom_histogram(position = "dodge", size = 0.5, color = "black") +
...
Ahora se realizan gráficos de mosaico para seguir visualizando las relaciones entre los grupos de causa de muerte y las demás variables importante
